...
export class NotificationResolverBase {
  ...
  async DeleteNotification(
    ...
    return this.service.DeleteNotification(args);
  }
  ...
  async GetNotification(
    ...
    return this.service.GetNotification(args);
  }
  ...
  async ListNotifications(
    ...
    return this.service.ListNotifications(args);
  }

  @graphql.Mutation(() => Notification)
  async UpdateNotification(
    @graphql.Args()
    args: NotificationUpdateInput
  ): Promise<Notification> {
    return this.service.UpdateNotification(args);
  }
}
