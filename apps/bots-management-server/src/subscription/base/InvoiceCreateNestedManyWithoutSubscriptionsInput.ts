...
@InputType()
class InvoiceCreateNestedManyWithoutSubscriptionsInput {
...
export { InvoiceCreateNestedManyWithoutSubscriptionsInput as InvoiceCreateNestedManyWithoutSubscriptionsInput };
