...
export class MessageResolverBase {
  ...
  async DeleteMessage(
    @graphql.Args()
    args: MessageWhereUniqueInput
  ): Promise<Message> {
    return this.service.DeleteMessage(args);
  }
  ...
  async GetMessage(
    ...
    return this.service.GetMessage(args);
  }

  @graphql.Query(() => [Message])
  async ListMessages(
    @graphql.Args()
    args: MessageFindManyArgs
  ): Promise<Message[]> {
    return this.service.ListMessages(args);
  }

  @graphql.Mutation(() => Message)
  async UpdateMessage(
    @graphql.Args()
    args: MessageUpdateInput
  ): Promise<Message> {
    return this.service.UpdateMessage(args);
  }
}
