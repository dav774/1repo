...
export class MessageControllerBase {
  ...
  async DeleteMessage(
    ...
    return this.service.DeleteMessage(body);
  }

  @common.Get("/messages/:id")
  @swagger.ApiOkResponse({
    type: Message,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async GetMessage(
    ...
    return this.service.GetMessage(body);
  }
  ...
  async ListMessages(
    ...
    return this.service.ListMessages(body);
  }

  @common.Patch("/messages/:id")
  @swagger.ApiOkResponse({
    type: Message,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async UpdateMessage(
    ...
    return this.service.UpdateMessage(body);
  }
}
